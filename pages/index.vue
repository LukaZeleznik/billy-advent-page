<template>
  <div class="min-h-screen bg-gradient-to-br from-red-50 via-white to-green-50 font-sans selection:bg-red-200 selection:text-red-900">
    <AdGrid />
    
    <footer class="text-center py-8 text-gray-500 text-sm space-y-2 relative">
